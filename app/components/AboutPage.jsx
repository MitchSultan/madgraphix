  ...
  return (
    <>
      ...
      <section className="bg-gray-100 py-12">
        <div className="overflow-x-auto mobile-scroll-x no-scrollbar snap-x">
          <div className="flex gap-6 w-max snap-x lg:grid lg:w-full lg:grid-cols-2 lg:gap-6 items-center">
            <div className='bg-white p-10 w-[85vw] min-w-[85vw] flex-shrink-0 snap-start lg:w-auto lg:min-w-0'>
      ...
      <section className="bg-gray-100 py-12">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="overflow-x-auto mobile-scroll-x no-scrollbar snap-x">
            <div className="flex gap-8 w-max snap-x md:grid md:grid-cols-2 lg:grid-cols-3 md:w-full p-10 rounded-lg">
              <div className="bg-white rounded-lg shadow-md p-6 w-[85vw] min-w-[85vw] flex-shrink-0 snap-start md:w-auto md:min-w-0">
      ...
      <section className="bg-white py-12">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 text-center">
          ...
          <div className="overflow-x-auto mobile-scroll-x no-scrollbar snap-x">
            <div className="flex gap-8 w-max snap-x lg:grid lg:min-w-full lg:grid-cols-4">
              {/* Joshua - Founder */}
              <div className="group relative rounded-lg overflow-hidden shadow-lg cursor-pointer h-80 w-[85vw] min-w-[85vw] flex-shrink-0 snap-start lg:w-auto lg:min-w-0">
                <img
          ...
          <div className="relative">
            ...
            <div className="grid gap-8 md:grid-cols-2">
              ...
              <div className="relative flex flex-col md:items-end gap-6">
                <div className="bg-gradient-to-br from-blue-500 to-cyan-500 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 w-full md:max-w-xl">
              ...
              {/* Step 2 - Strategy */}
              <div className="relative flex flex-col md:items-start gap-6">
                <div className="bg-gradient-to-br from-purple-500 to-indigo-500 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 w-full md:max-w-xl">
              ...
              {/* Step 3 - Design */}
              <div className="relative flex flex-col md:items-end gap-6">
                <div className="bg-gradient-to-br from-pink-500 to-rose-500 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 w-full md:max-w-xl">
                  <div className="flex items-center justify-between mb-4 md:flex-row-reverse">
                    <div className="w-16 h-16 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center">
                      <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {/* Step 4 - Refinement */}
              <div className="relative flex flex-col md:items-start gap-6">
                <div className="bg-gradient-to-br from-amber-500 to-orange-500 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 w-full md:max-w-xl">
                  <div className="flex items-center justify-between mb-4">
              ...
              {/* Step 5 - Delivery */}
              <div className="relative flex flex-col md:items-end gap-6">
                <div className="bg-gradient-to-br from-emerald-500 to-teal-500 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 w-full md:max-w-xl">
                  <div className="flex items-center justify-between mb-4 md:flex-row-reverse">
                    <div className="w-16 h-16 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center">
                      <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
