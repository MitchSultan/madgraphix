...
export function AppSidebar({
  ...
  const filteredNavMain = prefixUrl(
    data.mainNav.filter((item) => item.roles?.includes(role))
  )
  const filteredDocuments = prefixUrl(
    data.documents.filter((item) => item.roles?.includes(role))
  )
  const filteredNavSecondary = prefixUrl(
    data.navSecondary.filter((item) => item.roles?.includes(role))
  )
